        ...
        if (view != null) {
            if (view.getId() == R.id.send_btn) {
                if (!inputAmount.getText().toString().isEmpty()) {
                    ...
                    SpecifyAmountFragmentDirections.ActionSpecifyAmountFragmentToConfirmationFragment action = SpecifyAmountFragmentDirections.actionSpecifyAmountFragmentToConfirmationFragment(amount).setRecipient(recipient);
